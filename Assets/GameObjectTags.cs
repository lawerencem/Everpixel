namespace Assets
{
    ...
    {
        public static readonly string ACTING_BOX = "ActingBox";
        ...
        public static readonly string MAIN_CANVAS = "MainCanvas";
        public static readonly string MODAL_BTN_PROTO = "ProtoAbilityBtnTag";
        public static readonly string MODAL_HEADER = "ActiveModalHeaderTag";
        public static readonly string MORALE = "MoraleTextTag";
        public static readonly string NAME = "ActingBoxNameTag";
        public static readonly string PROTO_ABILITY_BTN = "ProtoAbilityBtn";
