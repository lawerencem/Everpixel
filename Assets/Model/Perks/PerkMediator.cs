        ...
        public void SetCharacterPerks(GenericCharacter c, List<PerkEnum> perks)
        {
            foreach(var perk in perks)
            {
                ...
                switch(genericPerk.Type)
                {
                    ...
                    case (PerkEnum.Shield_Happy): { c.Perks.PreHitPerks.Add(genericPerk as ShieldHappy); } break;
                    case (PerkEnum.Squishy): { c.Perks.WhenHitPerks.Add(genericPerk as Squishy); } break;
