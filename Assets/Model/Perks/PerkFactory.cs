    ...
    public class PerkFactory : AbstractSingleton<PerkFactory>
    {
        ...
        public GenericPerk CreateNewObject(PerkEnum toCreate)
        {
            switch(toCreate)
            {
                ...
                case (PerkEnum.Bastion): { return new Bastion(); }
                case (PerkEnum.Bully): { return new Bully(); }
                ...
                case (PerkEnum.Medium_Shield_Expert): { return new MediumShieldExpert(); }
                ...
                case (PerkEnum.Two_Handed_Expert): { return new TwoHandedExpert(); }
                default: { return null; }
            }
        } 
    }
