    ...
    public class WeaponReader : GenericEquipmentReader
    {
        ...
        protected override void HandleIndex(string name, string skill, string param, string value, ref EquipmentTierEnum tier)
        {
            ...
            switch (param)
            {
                ...
                case ("Fatigue_Cost_Mod"): { HandleStatsFromFile(name, WeaponStatsEnum.Fatigue_Cost_Mod, v, tier); } break;
        ...
        private void HandleStatsFromFile(string name, WeaponStatsEnum x, double v, EquipmentTierEnum tier)
        {
            ...
            switch (x)
            {
                ...
                case (WeaponStatsEnum.Fatigue_Cost_Mod): { stats.Table[key].FatigueCostMod = v; } break;
